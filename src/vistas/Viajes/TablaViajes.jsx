      ...
      {viajesOrdenados.map((viaje, index) => (
        ...
        >
          <Row className="align-items-center h-100">
            ...
            <Col xs={7} className="d-flex flex-column gap-1 p-1 justify-content-center">
              <div className="d-flex justify-content-between align-items-center gap-2 p-0 w-100">
            ...
            <Col xs={3} className="d-flex flex-column text-center justify-content-center">
